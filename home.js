...
function canWeDeliver(zipcode){
    if (zipcode === 85205, 85204, 85203, 85213, 85206) {
        console.log ('Your in our delivery zone!')
        
    }else {
        console.log (' Sorry we cant delvier to that address!')
    }
}
canWeDeliver(85210)
canWeDeliver(85511)
...
function canWeDeliverTwo(zipcode) {
    ...
    console.log ('Your in our delivery area!')
}
canWeDeliverTwo(85210)
...
deals.replace (deals.title, '10% Off!')
